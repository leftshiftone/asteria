...
{version}, July 29, 2014, Asciidoctor 1.5 article template
:toc:
:icons: font
:quick-uri: https://asciidoctor.org/docs/asciidoc-syntax-quick-reference/

include::sub/forrest.adoc[]
...
.Image caption
.[[figure-infrastructure-overview]]Infrastructure Overview
image::../resources/images/infrastructure-overview.svg[width=100%]
